...
@section('breadcrum-title', 'Sidang / Seminar Proposal')
        ...
        <div class="container-lg px-4">
            <div class="row g-4 mb-4">
                <div class="card mb-4 py-3">
                    <span class="fw-semibold fs-5 mb-1">Daftar seminar proposal</span>
                    <hr />
                    <div class="row">
                        <form id="formSempro" action="{{ route('user.sid-postSempro') }}" method="POST"
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-12">
                                    <label for="formFile1" class="form-label">Form 01 (Pendaftaran Seminar)</label>
                                    <div class="input-group mb-3">
                                ...
                                <div class="col-12">
                                    <label for="formFile2" class="form-label">Form 07 (Logbook Bimbingan)</label>
                                    <div class="input-group mb-3">
                                ...
                                <div class="col-12">
                                    <label for="formFile2" class="form-label">Draft Proposal (.pdf, .docx)</label>
                                    <div class="input-group mb-3">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <table class="table table-bordered" id="tableDataSempro">
                            <thead>
                                <tr class="table-secondary">
                                    ...
                                    <th scope="col">Draft Proposal</th>
...
@push('script')
    <script>
        $(document).ready(function() {
            /** GET::DATA_SEMPRO */
            $('#tableDataSempro').DataTable({
                dom: 'ftp',
                responsive: true,
                lengthChange: false,
                processing: true,
                serverSide: true,
                ajax: '{{ route('user.sid-jsonSempro') }}',
                columns: [{
                        data: 'topik',
                        name: 'topik'
                    },
            ...
            /** POST::DATA_SEMPRO */
            $('#formSempro').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#formSempro')[0].reset();
                        $('#tableDataSempro').DataTable().ajax.reload();
                    },
                    error: function(xhr) {
