        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-group">
                ...
                <ul class="nav-group-items compact">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.data-admin') }}"><span class="nav-icon"><span
                                    class=""></span></span> Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.data-dosen') }}"><span class="nav-icon"><span
                                    class=""></span></span> Dosen</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.data-user') }}"><span class="nav-icon"><span
                                    class=""></span></span>
                            Mahasiswa</a>
                    </li>
                </ul>
            ...
            <li class="nav-group">
                ...
                <ul class="nav-group-items compact">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.ta-prop') }}"><span class="nav-icon"><span
                                    class=""></span></span>Rekapitulasi Proposal</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.ta-umum') }}"><span class="nav-icon"><span
                                    class=""></span></span>Rekapitulasi Umum</a>
                    </li>
                </ul>
            </li>
