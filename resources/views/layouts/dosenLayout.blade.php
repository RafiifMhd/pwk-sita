...
<body>
    <div class="sidebar sidebar-light sidebar-fixed border-end" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dosen.periode-info') }}">
                    <svg class="nav-icon text-dark">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dosen.periode-topik') }}">
                    <svg class="nav-icon text-dark">
                        <use xlink:href="{{ secure_asset('coreui/vendors/@coreui/icons/svg/free.svg#cil-library-add') }}">
                        </use>
                    </svg>
                    Buat Topik TA</a>
            </li>
            ...
            <li class="nav-group">
                <a class="nav-link nav-group-toggle" href="#">
                    <svg class="nav-icon text-dark">
                        <use xlink:href="{{ secure_asset('coreui/vendors/@coreui/icons/svg/free.svg#cil-people') }}"></use>
                    </svg>
                    Data Mahasiswa</a>
                <ul class="nav-group-items compact">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dosen.mhs-proposal') }}"><span class="nav-icon"><span
                                    class=""></span></span>Pengajuan Proposal</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dosen.mhs-bimbingan') }}"><span class="nav-icon"><span
                                    class=""></span></span>Daftar Mahasiswa</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dosen.mhs-penilaian') }}"><span class="nav-icon"><span
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dosen.sched-jadwal') }}">
                    <svg class="nav-icon text-dark">
            ...
            <div class="container-fluid px-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb my-0">
                        <li class="breadcrumb-item"><a href="{{ route('dosen.home') }}">Home</a></li>
